...
@section('content_header')
    <h1><b>Listado de Préstamos</b></h1>
    <hr>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title my-1">Préstamos registrados</h3>
                    <div class="card-tools">
                        @can('admin.prestamos.create')
                            <a href="{{ route('admin.prestamos.create') }}" class="btn btn-primary btn-sm"><i
                                    class="fa fa-plus"></i>
                                Crear nuevo</a>
                        @endcan
                    </div>
                                            ...
                                            @if ($prestamo->tiene_cuota_pagada)
                                                @can('admin.prestamos.show')
                                                    <a href="{{ route('admin.prestamos.show', $prestamo->id) }}"
                                                        ...
                                                        data-bs-placement="top" title="Ver Préstamo">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                @endcan

                                                @can('admin.prestamos.contratos')
                                                    <a href="{{ route('admin.prestamos.contratos', $prestamo->id) }}"
                                                        target="_blank" class="btn btn-warning btn-sm" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Ver Contrato">
