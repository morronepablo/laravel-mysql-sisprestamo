...
@section('content_header')
    <h1><b>Modificar datos del préstamo</b></h1>
    <hr>
@stop
            ...
            <div class="col-md-12">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                                    ...
                                    <select name="cliente_id" id="select_cliente"
                                        ...
                                        @foreach ($clientes as $cliente)
                                            <option value="{{ $cliente->id }}"
                                                ...
                                                {{ $prestamo->cliente_id == $cliente->id ? 'selected' : '' }}>
                        ...
                        <div class="" id="contenido_cliente">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="nro_documento" id="nro_documento"
                                                value="{{ $prestamo->cliente->nro_documento }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="nombre" id="nombre"
                                                value="{{ $prestamo->cliente->nombre }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="apellido" id="apellido"
                                                value="{{ $prestamo->cliente->apellido }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" name="fecha_nacimiento" id="fecha_nacimiento"
                                                value="{{ $prestamo->cliente->fecha_nacimiento }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="genero" id="genero"
                                                value="{{ $prestamo->cliente->genero }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="email" name="email" id="email"
                                                value="{{ $prestamo->cliente->email }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="celular" name="celular" id="celular"
                                                value="{{ $prestamo->cliente->celular }}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="ref_celular" name="ref_celular" id="ref_celular"
                                                value="{{ $prestamo->cliente->ref_celular }}" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="monto_prestado"
                                        value="{{ old('monto_prestado', '$ ' . number_format($prestamo->monto_prestado, 2, ',', '.')) }}"
                                        class="form-control text-right {{ $errors->has('monto_prestado') ? 'is-invalid' : '' }}">
                                    <input type="text" name="monto_prestado"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <select name="modalidad" id="select_modalidad" value="{{ old('modalidad') }}"
                                        ...
                                        <option value="Diario" {{ $prestamo->modalidad == 'Diario' ? 'selected' : '' }}>
                                            Diario</option>
                                        <option value="Semanal" {{ $prestamo->modalidad == 'Semanal' ? 'selected' : '' }}>
                                            Semanal</option>
                                        <option value="Quincenal"
                                            {{ $prestamo->modalidad == 'Quincenal' ? 'selected' : '' }}>Quincenal</option>
                                        <option value="Mensual" {{ $prestamo->modalidad == 'Mensual' ? 'selected' : '' }}>
                                            Mensual</option>
                                        <option value="Anual" {{ $prestamo->modalidad == 'Anual' ? 'selected' : '' }}>
                                            Anual</option>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_inicio" id="fecha_inicio"
                                        value="{{ $prestamo->fecha_inicio }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
